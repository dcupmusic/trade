...
import joblib
import json
from lstm_v1_multi_earlystop import BiLSTMClassifierWithAttention

app = Flask(__name__)

model = BiLSTMClassifierWithAttention(84, 32, 2, 3, 0.1)
model.load_state_dict(torch.load('models/trained_model_lstm_epoch_5000.pth', map_location=torch.device('cpu')))
model.eval()
